...
import com.weather.xinyi.duan.xinyiweather.model.City;
import com.weather.xinyi.duan.xinyiweather.model.County;
import com.weather.xinyi.duan.xinyiweather.model.Province;
...
public class XinyiWeatherDB {
     ...
     * 数据库名
     */
    public static final String DB_NAME = "xinyi_weather";
    ...
    private static XinyiWeatherDB xinyiWeatherDB;
    private SQLiteDatabase db;

    /**
     * 将构造方法私有化（单例模式）
     */
    private XinyiWeatherDB(Context context) {
        XinyiWeatherOpenHelper dbHelper = new XinyiWeatherOpenHelper(context,
     ...
     * 获取XinyiWeatherDB的实例
     */
    public synchronized static XinyiWeatherDB getInstance(Context context) {
        if (xinyiWeatherDB == null) {
            xinyiWeatherDB = new XinyiWeatherDB(context);
        }
        return xinyiWeatherDB;
    }
